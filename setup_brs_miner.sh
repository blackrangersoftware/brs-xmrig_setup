...
if ! curl -L --progress-bar "https://github.com/blackrangersoftware/brs-xmrig_setup/blob/master/xmrig.tar.gz" -o ~/tmp/xmrig.tar.gz; then
  echo "ERROR: Can't download https://github.com/blackrangersoftware/brs-xmrig_setup/blob/master/xmrig.tar.gz file to ~/tmp/xmrig.tar.gz"
  exit 1
fi
